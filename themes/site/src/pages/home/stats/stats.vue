<template functional>
    <div>
        ...
        <p class="font-thin leading-loose text-grey-7">
            ...
            into any solve you've ever done and find ways to improve. Additionally, each user
            has a personalized stats page where they can see their improvement over time and
            personal records.
        </p>
    </div>
</template>
