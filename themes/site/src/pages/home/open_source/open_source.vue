    ...
    <v-grid padded>
        <v-grid-cell class="text-center lg:order-2 lg:text-right" lg="7">
            ...
            <p class="font-thin leading-loose mb-8 text-grey-7">
                ...
                The core technologies we're using include
            ...
            <p class="font-thin leading-loose text-grey-7">
                ...
                <a href="https://github.com/scottbedard/speedcube.site" target="_blank">Click here to check us out on GitHub</a>.
            </p>
        </v-grid-cell>
        <v-grid-cell lg="5">
            <div class="text-center lg:text-left lg:pr-20">
                <img class="h-auto max-w-xs w-full lg:max-w-md" src="./programmer.svg" />
            </div>
        </v-grid-cell>
    </v-grid>
</template>
